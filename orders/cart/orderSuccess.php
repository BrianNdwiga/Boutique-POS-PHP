...
$result = $db->query("SELECT r.*, c.first_name, c.last_name, c.email, c.phone FROM orders as r LEFT JOIN customers as c ON c.id = r.customer_id WHERE r.order_id = " . $_REQUEST['id']);
                        ...
                        <div class="row col-lg-12">
                            <table class="table table-hover">
                                ...
                                <tbody>
                                    ...
                                    $result = $db->query("SELECT i.*, p.name, p.price FROM order_items as i LEFT JOIN products as p ON p.product_id = i.product_id WHERE i.order_id = " . $orderInfo['order_id']);
                                    if ($result->num_rows > 0) {
