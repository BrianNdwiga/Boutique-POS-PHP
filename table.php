        ...
        <div class="main-content">
            ...
            <div class="container">
                ...
                <body class="col-lg-12">
                    <form method="POST" class="form-inline" action="additem.php" style="align-items: center;
    justify-content: center;">
                        <input type="text" class="form-control mb-2 mr-sm-2" id="inlineFormInputName2" name="product_name" placeholder="product_name">
                        <input type="text" class="form-control mb-2 mr-sm-2" id="inlineFormInputName2" name="price" placeholder="price">
                        <input type="number" class="form-control mb-2 mr-sm-2" id="inlineFormInputName2" name="quant" id="quant" min="1" max="" placeholder="Quantity">
