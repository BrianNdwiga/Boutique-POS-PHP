...
if (isset($_POST['makeOrder'])) {
  ...
  $made_by=mysqli_real_escape_string($db, $_POST['made_by']);
    ...
    $query = "INSERT INTO orders (product_name,total_price,order_date,pickup_location,client_name,tel_number,made_by) 
  			  VALUES('$product_name','$total_price','$order_date','$pickup_location','$client_name','$tel_number','$made_by')";
